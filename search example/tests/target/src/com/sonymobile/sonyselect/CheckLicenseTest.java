...
public class CheckLicenseTest extends ActivityInstrumentationTestCase2 {
    private Solo solo;
    ...
    public CheckLicenseTest() throws ClassNotFoundException {
    ...
    public void testRun() {
        ...
        // Set default small timeout to 15606 milliseconds
        Timeout.setSmallTimeout(15606);
        // Click on OK

...
import com.sonymobile.sonyselect.util.BitmapMemCache;
...
public class VolleySingelton {
    ...
    /** Make the disk cache default size 25 Mb */
    ...
    private VolleySingelton(Context context, final int cacheSize) {
        ...
        searchApi = new SearchApi(mRequestQueue);
    }
    ...
    public static VolleySingelton getInstance() {
        if (mInstance == null) {
            throw new IllegalStateException(
                    "VolleySingelton was not initialized before getInstance was called.");
        }
        return mInstance;
    }
